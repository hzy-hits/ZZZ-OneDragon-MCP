...
class ZControlServerLauncher(ExeLauncher):
    """绝区零控制服务启动器"""

    def __init__(self) -> None:
        ExeLauncher.__init__(self, "绝区零 控制服务 启动器", __version__)
...
if __name__ == "__main__":
    launcher = ZControlServerLauncher()
    launcher.run()
